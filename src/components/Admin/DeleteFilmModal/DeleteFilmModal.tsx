...
import { changeTextModal, toggleShowDeleteFilmModal } from "../../../redux/action-creators/modal";
...
const DeleteFilmModal: FC = () => {
  ...
  const handleClose = (): IToggleDeleteFilmShowModal => dispatch(toggleShowDeleteFilmModal(false));
  ...
  const { deleteFilmModalShow } = useSelector((state: RootState) => state.modal);
  ...
  return (
    ...
    >
      <Modal.Header closeButton>
        <Modal.Title id="contained-modal-title-center">Do you really want to delete this film?</Modal.Title>
      </Modal.Header>
      <Modal.Footer>
